...
public class IndexedBuilder extends AnnotationBuilder<Indexed> implements Indexed {
    ...
    public IndexedBuilder background(final boolean background) {
        put("background", background);
        return this;
    }

    public IndexedBuilder dropDups(final boolean dropDups) {
        put("dropDups", dropDups);
        return this;
    }

    public IndexedBuilder expireAfterSeconds(final int expireAfterSeconds) {
        put("expireAfterSeconds", expireAfterSeconds);
        return this;
    }

    public IndexedBuilder name(final String name) {
        put("name", name);
        return this;
    }

    public IndexedBuilder sparse(final boolean sparse) {
        put("sparse", sparse);
        return this;
    }

    public IndexedBuilder unique(final boolean unique) {
        put("unique", unique);
        return this;
    }

    public IndexedBuilder value(final IndexDirection value) {
        put("value", value);
        return this;
    }
