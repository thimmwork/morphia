...
public final class MorphiaReference<T> {
    ...
    /**
     * @return if this reference should store only the ID value
     */
    ...
    /**
     * @param idOnly true if this reference should store only the ID value
     * @return this
     */
    ...
    /**
     * @return the DBRef form of this reference
     */
    ...
    /**
     * @return the entity referenced by this reference.  might be null
     */
    public T getEntity() {
        return entity;
    }
