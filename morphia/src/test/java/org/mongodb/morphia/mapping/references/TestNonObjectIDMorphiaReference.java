...
public class TestNonObjectIDMorphiaReference extends TestBase {


    @Test
    public void testOldReferencesWithNew() {
        getMorphia().map(OldContainer.class, Container.class);
        final Contained contained = new Contained("some id", "contained");
    ...
    public static class Contained {
        ...
        public Contained(final String objectId, final String name) {
            id = objectId;
            this.name = name;
        }
